...
namespace QuanLyCaSi_XLAJAX.Controllers
{
    public class BaiHatController : Controller
    {
        ...
        [Route("/BaiHat/LietKeCacBaiHatCoTrongAlbum/{maAlbum}")]
        public IActionResult LietKeCacBaiHatCoTrongAlbum(string MaAlbum)
        {
            StoreContext context = HttpContext.RequestServices.GetService(typeof(QuanLyCaSi_XLAJAX.Models.StoreContext)) as StoreContext;
            return View(context.LietKeCacBaiHatCoTrongAlbum(MaAlbum));
        }
    }
}
